...
import com.nauht.shortlink.linkmap.LinkController;
...
public class JwtService {
  ...
  org.slf4j.Logger logger = LoggerFactory.getLogger(JwtService.class);
  ...
  public String generateToken(
    ...
    extraClaims.put("userFirstName", user.getFirstname());
    extraClaims.put("userLastName", user.getLastname());
